...
int main(int argc, char* argv[])
{
	...
	dumper dump(dump_step, indata, slicing, gauge);
	//================================================================
	// Allocate monitor Class
	//================================================================
	cout << " GR: allocating monitor..." << endl;
	Monitor monitor(note_step, monitor_filename, grid, indata,
	...
	// Initialize
	//================================================================
	cout << " GR: initializing manager..." << endl;
	...
	//================================================================
		cout << " GR: integrating manager..." << endl;
