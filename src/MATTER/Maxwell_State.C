#include "Maxwell_State.h"
    ...
    // Constructor
    //===============================================
    maxwell_state::maxwell_state(Grid* grid_i, dumper* dump_i, const char* name_i) :
    ...
    // check properties
    //===============================================
    void maxwell_state::check_props() {
    ...
    // fill ghosts
    //===============================================
    void maxwell_state::fill_ghosts() {
        for (int i = 0; i < N_fcts; i++)
            (*fct_list)[i].fill_ghosts();
    };
    //===============================================
    // addition
    //===============================================
    void maxwell_state::add(double factor, maxwell_state* rhs) {
        for (int i = 0; i < N_fcts; i++)
    ...
    // addition 
    //===============================================
    void maxwell_state::add(maxwell_state* maxwell_state1, double factor, maxwell_state* maxwell_state2) {
        for (int i = 0; i < N_fcts; i++)
    ...
    // addition
    //===============================================
    void maxwell_state::equals(maxwell_state* rhs) {
        for (int i = 0; i < N_fcts; i++) {
    ...
    //===============================================
    void maxwell_state::char_OB(maxwell_state* last, double dt) {
        for (int i = 0; i < N_fcts; i++)
    ...
    //===============================================
    void maxwell_state::function_names() {
    ...
    //===============================================
    const char* maxwell_state::Name() { return name; };
    //===============================================
    // Dump grid functions
    //===============================================
    void maxwell_state::dump_fcts(double time, double prop_time, int timestep,
        const char* suffix) {
    ...
    //===============================================
    int maxwell_state::assemble_dump_list(const char* dump_list_file) {
        ifstream infile;
    ...
    // Regrid
    //===============================================
    void maxwell_state::Regrid(VecDoub r_new) {
        for (int i = 0; i < N_fcts; i++)
