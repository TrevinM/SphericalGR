#include "Hydro_State.h"
    ...
    // Constructor
    //===============================================
    hydro_state::hydro_state(Grid* grid_i, dumper* dump_i, const char* name_i) :
    ...
    // addition
    //===============================================
    void hydro_state::add(double factor, hydro_state* rhs) {
        for (int i = 0; i < N_fcts; i++)
    ...
    // addition 
    //===============================================
    void hydro_state::add(hydro_state* hydro_state1, double factor, hydro_state* hydro_state2) {
        for (int i = 0; i < N_fcts; i++)
    ...
    // equals
    //===============================================
    void hydro_state::equals(hydro_state* rhs) {
        for (int i = 0; i < N_fcts; i++) {
            fct_list[i]->equals(rhs->fct_list[i]);
        }
    };
    void hydro_state::equals(double number) {
        for (int i = 0; i < N_fcts; i++) {
    ...
    //===============================================
    bool hydro_state::IsEqualTo(hydro_state* s) {
        bool fct_equal = true;
    ...
    //===============================================
    void hydro_state::function_names() {
    ...
    //===============================================
    const char* hydro_state::Name() { return name; };
    //===============================================
    // Dump grid functions
    //===============================================
    void hydro_state::dump_fcts(double time, double prop_time, int timestep,
        const char* suffix) {
    ...
    //===============================================
    int hydro_state::assemble_dump_list(const char* dump_list_file) {
        ifstream infile;
    ...
    // Regrid
    //===============================================
    void hydro_state::Regrid(VecDoub r_new) {
        for (int i = 0; i < N_fcts; i++)
