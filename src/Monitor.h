...
public:
    ...
    Monitor(int step, const char* filename_i, Grid* grid, InData* indata_i,
        ...
        monitorfilename << "output/" << filestem << "_" << N_r << "_" << N_theta
            << ".mon" << ends;
        ...
        constraintmonitorfilename << "output/" << filestem << "_" << N_r << "_"
        ...
        invmonitorfilename << "output/" << filestem << "_" << N_r << "_"
    ...
    void note_invariants(int time_step, double time, double tau,
        ...
        double zeta_center, double zeta_max) {
        invoutfile << setw(16) << time
            ...
            << setw(16) << setprecision(8) << zeta_center
            << setw(16) << setprecision(8) << zeta_max
            << endl;
    };
    //================================================
    // regrid
