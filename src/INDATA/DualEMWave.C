...
// Constructor
//================================================
DualEMWave::DualEMWave(char* indata_input, Grid* grid_i, Cosmology* cosmology) :
    ...
    cout << "      diagnostics " << tau_star << " and " << xi << endl;
...
// Initializer
//================================================
bool DualEMWave::Initialize(gf3d& fct) {
...
double DualEMWave::Solve_Constraints(bool verbose) {
    Compute_Fields();
    Compute_Sources();
    double res = Residual();
...
//================================================
double DualEMWave::h_rr_analytical(double rl, double thetal, double phil, double t) {
    return 0.0;
};
double DualEMWave::h_rt_analytical(double r, double theta, double phi, double t) {
    return 0.0;
};
double DualEMWave::h_rp_analytical(double r, double theta, double phi, double t) {
    return 0.0;
};
double DualEMWave::h_tt_analytical(double rl, double thetal, double phil, double t) {
    return 0.0;
};
double DualEMWave::h_tp_analytical(double r, double theta, double phi, double t) {
    return 0.0;
};
double DualEMWave::h_pp_analytical(double rl, double thetal, double phil, double t) {
    return 0.0;
};
double DualEMWave::phi_analytical(double rl, double thetal, double phil, double tl) {
    // reality check:
...
//================================================
double DualEMWave::lam_r_analytical(double r, double theta, double phi, double t,
    bool& done) {
    done = true; return 0;
}
double DualEMWave::lam_t_analytical(double r, double theta, double phi, double t,
    bool& done) {
    done = true; return 0;
}
double DualEMWave::lam_p_analytical(double r, double theta, double phi, double t,
    bool& done) {
    done = true; return 0;
}
//================================================
...
//================================================
double DualEMWave::a_rr_analytical(double r, double theta, double phi, double t) {
    int i = grid->i_ind(r);
...
double DualEMWave::a_rt_analytical(double r, double theta, double phi, double t) {
    int i = grid->i_ind(r);
    int j = grid->j_ind(theta);
    int k = grid->k_ind(phi);
    double psi6 = pow(psi(i, j, k), 6);
...
double DualEMWave::a_rp_analytical(double r, double theta, double phi, double t) {
    int i = grid->i_ind(r);
    int j = grid->j_ind(theta);
    int k = grid->k_ind(phi);
    double psi6 = pow(psi(i, j, k), 6);
...
double DualEMWave::a_tt_analytical(double r, double theta, double phi, double t) {
    int i = grid->i_ind(r);
    int j = grid->j_ind(theta);
    int k = grid->k_ind(phi);
    double psi6 = pow(psi(i, j, k), 6);
...
double DualEMWave::a_tp_analytical(double r, double theta, double phi, double t) {
    int i = grid->i_ind(r);
    int j = grid->j_ind(theta);
    int k = grid->k_ind(phi);
    double psi6 = pow(psi(i, j, k), 6);
...
double DualEMWave::a_pp_analytical(double r, double theta, double phi, double t) {
    int i = grid->i_ind(r);
    int j = grid->j_ind(theta);
    int k = grid->k_ind(phi);
    double psi6 = pow(psi(i, j, k), 6);
...
double DualEMWave::K_analytical(double r, double theta, double phi, double t) {
    return 0.0;
};
//================================================
// Analytical solution for gauge
//================================================
double DualEMWave::lapse_analytical(double rl, double thetal, double phil, double t) {
    int i = grid->i_ind(rl);
    int j = grid->j_ind(thetal);
    int k = grid->k_ind(phil);
    double psil = psi(i, j, k);
...
double DualEMWave::shift_r_analytical(double r, double theta, double phi, double t) {
    // return 2.0 * r / (1.0 + r*r);
    return 0.0;
};
double DualEMWave::shift_t_analytical(double r, double theta, double phi, double t) {
    return 0.0;
};
double DualEMWave::shift_p_analytical(double r, double theta, double phi, double t) {
    return 0.0;
};
//================================================
// Analytical solution for auxiliary functions
//================================================
double DualEMWave::Theta_analytical(double r, double theta, double phi, double t) {
    return 0.0;
}
double DualEMWave::B_r_analytical(double r, double theta, double phi, double t) {
    return 0.0;
}
double DualEMWave::B_t_analytical(double r, double theta, double phi, double t) {
    return 0.0;
}
double DualEMWave::B_p_analytical(double r, double theta, double phi, double t) {
    return 0.0;
}
//================================================
// Analytical solution for hydro
//================================================
double DualEMWave::rho_0_analytical(double rl, double thetal, double phil, double tl) {
    return 0.0;
};
double DualEMWave::P_analytical(double r, double theta, double phi, double t) {
    return 0.0;
};
double DualEMWave::v_r_analytical(double r, double theta, double phi, double t) {
    return 0.0;
};
double DualEMWave::v_t_analytical(double r, double theta, double phi, double t) {
    return 0.0;
};
double DualEMWave::v_p_analytical(double r, double theta, double phi, double t) {
    return 0.0;
};
//================================================
// Analytical solution for scalar field
//================================================
double DualEMWave::sf_analytical(double r, double theta, double phi, double t) {
    return 0.0;
};
double DualEMWave::pi_analytical(double r, double theta, double phi, double t) {
    return 0.0;
};
//================================================
...
double DualEMWave::e_p_analytical(double r, double theta, double phi, double t) {
    return 0.0;
};
//
...
//
double DualEMWave::a_r_analytical(double r, double theta, double phi, double t) {
    return compute_a_r(r, theta);
};
double DualEMWave::a_t_analytical(double r, double theta, double phi, double t) {
    return compute_a_t(r, theta);
};
double DualEMWave::a_p_analytical(double r, double theta, double phi, double t) {
    return compute_a_p(r, theta);
};
double DualEMWave::as_r_analytical(double r, double theta, double phi, double t) {
    return compute_as_r(r, theta);
};
double DualEMWave::as_t_analytical(double r, double theta, double phi, double t) {
    return compute_as_t(r, theta);
};
double DualEMWave::as_p_analytical(double r, double theta, double phi, double t) {
    return compute_as_p(r, theta);
};
//================================================
// Analytical solution for radiation
//================================================
double DualEMWave::E_analytical(double r, double theta, double phi, double t) {
    return 0.0;
};
double DualEMWave::F_0_analytical(double r, double theta, double phi, double t) {
    return 0.0;
}
double DualEMWave::F_r_analytical(double r, double theta, double phi, double t) {
    return 0.0;
};
double DualEMWave::F_t_analytical(double r, double theta, double phi, double t) {
    return 0.0;
};
double DualEMWave::F_p_analytical(double r, double theta, double phi, double t) {
    return 0.0;
};
...
//===============================================================
void DualEMWave::curl(gf3d& a_r, gf3d& a_t, gf3d& a_p,
...
// Dump function
//================================================
void DualEMWave::dump(gf3d* fct, int step) {
